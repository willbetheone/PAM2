...
//----------------------------------------------------------------------------
HMatrix::HMatrix (const APoint& translate)
{
...
//----------------------------------------------------------------------------
void HMatrix::MakeTranslation (const APoint& translation)
{
    MakeIdentity();
    mEntry[12] = translation.X();
    mEntry[13] = translation.Y();
    mEntry[14] = translation.Z();
    mEntry[15] = translation.W();
}
//----------------------------------------------------------------------------
